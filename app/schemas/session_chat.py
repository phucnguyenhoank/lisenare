...
class RuntimeSession:
    def __init__(
        self, list_question, topic, theta, history, current_question_id
    ):
        ...
        self._valid_ids = {
            str(q.order_id) for q in list_question if q.order_id is not None
        }

    def get_question_by_id(self, qid: str) -> dict | None:

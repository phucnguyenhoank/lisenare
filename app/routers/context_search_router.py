...
from app.schemas import ContextSearchRequest, VideoContextSearchResult, BrickContextSearch
...
def search_context_videos(
    ...
    return context_search_service.search_context_videos(context_search_request.query)

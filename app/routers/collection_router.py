...
from app.services import auth_service, collection_service, brick_override_service
...
def get_learner_collections(
    ...
    offset = (page - 1) * limit
    return collection_service.get_user_learning_collections(session, current_learner.id, group_name, limit, offset)
...
def get_group_stats(
    ...
    return collection_service.get_learning_collection_group_stats(session, current_learner.id)

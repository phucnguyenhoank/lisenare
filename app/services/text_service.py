...
class TextService:
    def evaluate_ipa_pronunciation(self, teacher_ipa: str, learner_ipa: str):
        ...
        analysis = []
        """ 
        Tag	        Logic	        Meaning in Pronunciation
        equal	    correct	        The learner said the sound perfectly.
        replace	    mispronounced	The learner said a different sound.
        delete	    missing	        The learner skipped a sound (e.g., didn't pronounce the 's' at the end).
        insert	    extra	        The learner added a sound that shouldn't be there.
        """
